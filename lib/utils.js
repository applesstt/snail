...
exports.convertAmrToMp3 = function(name, callback) {
  var callback = callback || function() {};
  try {
    var process = new ffmpeg('./public/upload/voice/' + name + '.amr');
    process.then(function(video) {
      video
        .setAudioChannels(1)
        .setAudioBitRate(16)
        .save('./public/upload/mp3/' + name + '.mp3', function(err, file) {
